        ...
        <ul className="menu menu-horizontal gap-2 p-0 text-base rtl:ml-20">
          <li className="dropdown relative inline-flex [--offset:9] [--placement:bottom-end] max-sm:[--placement:bottom]">
            ...
            >
              ...
              <li>
                <Link className="dropdown-item" to="/form-elements">
                  Form Elements
                </Link>
              </li>
            </ul>
          ...
          <li className="dropdown relative [--offset:9] [--placement:bottom-end] max-sm:[--placement:bottom]">
            ...
            >
              <li>
                <Link className="dropdown-item" to="/accordion">
                  Accordion
                </Link>
              </li>
              <li>
                <Link className="dropdown-item" to="/overlays">
                  Overlays
                </Link>
              </li>
              <li>
                <Link className="dropdown-item" to="/advance-forms">
                  Advance Forms
                </Link>
              </li>
            </ul>
